...
export default function FlowItems({ no, title, children, diviBorder=false }: FlowProps) {
	
    let isDivi = diviBorder ? 'sm:border-r border-dashed' : '';

	return (
		<> 
			<div className={`space-y-5 ${ isDivi } border-gray-300 dark:border-slate-600`}>
